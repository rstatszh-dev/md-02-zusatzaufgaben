...
6.  Ändere neben der Codeblock-Option `#| eval:` den Wert von `false` auf `true`.

7.  Wandel das Dokument in das HTML-Format um (klick: Render) und behebe eventuelle Fehler.
...
2.  Verwende die Funktion `ggplot()` und das Objekt `gapminder_2007`, um einen Boxplot mit den folgenden visuellen Eigenschaften zu erstellen:

    -   Kontinent auf der x-Achse

    -   Lebenserwartung auf der y-Achse
...
4.  Was sind die Datentypen der drei Variablen, die für ästhetische Zuordnungen verwendet werden?
