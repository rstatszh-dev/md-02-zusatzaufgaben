...
Der Code für diese Aufgabe ist bereits vorbereitet. Ein kleiner Teil ist gleich wie in `md-02a-erstelle-ein-diagramm.qmd`, jedoch wurde der Code hier noch erweitert um die Daten zusammenzufassen. Mit diesen neuen R Funktionen werden wir uns nächste Woche beschäftigen.
